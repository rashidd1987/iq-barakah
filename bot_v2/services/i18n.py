...
TEXTS = {
    "ru": {
        ...
        "menu.tariffs": "🎓 Тарифы",
        "menu.jarwas": "🤖 Джарвас — AI-наставник",
        "menu.howto": "Как проходить программу",
        "menu.language": "🌍 Язык",
        "menu.updated": "Меню обновлено · {version}",
        "bottom.diag": "🔍 Диагностика",
        "bottom.miniapp": "📱 Личный кабинет",
        "bottom.howto": "❓ Как проходить",
        "bottom.program": "📖 Мой путь",
        "bottom.payment": "💳 Оплата",
        "bottom.reminders": "🔔 Напоминания",
        "bottom.curator": "💬 Связаться с куратором",
        "bottom.muhasaba": "🌙 Вечерний разбор",
        "bottom.site": "🌐 Сайт",
        "bottom.jarwas": "🤖 Джарвас",
        "bottom.help": "🙋 Нужна помощь",
        "bottom.channel": "📢 Канал",
        "bottom.language": "🌍 Язык",
        "bottom.placeholder": "Выбери действие",
        ...
        "diag.level_a": "I — Пробуждение (делаю первые шаги)",
        "diag.level_b": "II — Практика (встраиваю в жизнь)",
        "diag.level_c": "III — Баракат (это часть меня, живу с благословением)",
        ...
        "diag.path_a": "🌱 IQ Barakah Старт — Тайм-менеджмент мусульманина",
        "diag.path_b": "🌱 IQ Barakah Старт → 📗 Сезон 1 · Основание",
        "diag.path_c": "📗 Сезон 1 → 📘 Сезон 2 · Строительство",
        "diag.button": "🎯 Пройти диагностику",
        "diag.prompt": "🎯 Нажми кнопку ниже, чтобы пройти диагностику:",
        "diag.route_prompt": "🎯 Чтобы подобрать правильный маршрут, пройди короткую диагностику.",
        ...
        "progress.week": "📅 Шаг {week} из {max_weeks} · {pct}% пройдено",
        "week.not_active": "Ты не активирован в программе.",
        "week.graduated": "🎓 *Поздравляем!*\n\nТы завершил *{level}*!\n\nБаракАллах фикум (да благословит тебя Аллах). Напиши куратору для перехода на следующий уровень. 🌿",
        "week.acked": "✅ *Шаг {week} завершён!*\n\nОткрывается следующий шаг. Ин ша Аллах 🌿",
        "lesson.ready": "Новый шаг открыт! Открой Mini App, чтобы изучить материал.",
        "lesson.open": "📱 Открыть Mini App",
        "jarwas.start": "🤖 *Джарвас — AI-наставник IQ Barakah*\n\nАссаляму алейкум! Я здесь, чтобы помочь тебе в рамках программы IQ Barakah.\nЗадай любой вопрос о программе, своём прогрессе или о том, с чего начать. 🌿\n\n_Для завершения нажми кнопку ниже._",
        "jarwas.end": "БаракАллах фикум (да благословит тебя Аллах). Напиши /start чтобы вернуться в меню. 🌿",
        "jarwas.close": "❌ Закрыть чат с Джарвасом",
        "jarwas.diag": "🎯 Пройти диагностику",
        "jarwas.buy_vakt": "🌱 Купить IQ Barakah Старт",
        "jarwas.buy_s1": "📗 Купить Сезон 1",
        "jarwas.curator": "🤝 Написать куратору",
        "reminders.soon": "🔔 Напоминания скоро будут здесь. Сейчас главный шаг — пройти диагностику и выбрать маршрут.",
        ...
        "onboarding.saved": (
            ...
            "и покажет, с какого маршрута начать — IQ Barakah Старт, Сезон 1 или более глубокая программа."
        ),
        ...
        "onboard.step2": (
            ...
            "С этого и начинается курс IQ Barakah Старт. Не «поменяй всю жизнь за день» — "
    ...
    "en": {
        ...
        "menu.howto": "How to progress",
        "menu.language": "🌍 Language",
        "menu.updated": "Menu updated · {version}",
        "bottom.diag": "🎯 Diagnostic",
        "bottom.miniapp": "📱 Personal cabinet",
        "bottom.howto": "❓ How to progress",
        "bottom.program": "📚 Program",
        "bottom.payment": "💳 Payment",
        "bottom.reminders": "🔔 Reminders",
        "bottom.curator": "💬 Contact curator",
        "bottom.muhasaba": "🌙 Muhasabah",
        "bottom.site": "🌐 Site",
        "bottom.jarwas": "🤖 Jarwas",
        "bottom.help": "🙋 Help",
        "bottom.channel": "📢 Channel",
        "bottom.language": "🌍 Language",
        "bottom.placeholder": "Choose action",
        ...
        "diag.level_a": "I — Awakening (taking first steps)",
        "diag.level_b": "II — Practice (building it into life)",
        "diag.level_c": "III — Barakah (it is part of me; I live with blessing)",
        ...
        "diag.button": "🎯 Take diagnostic",
        "diag.prompt": "🎯 Press the button below to take the diagnostic:",
        "diag.route_prompt": "🎯 To choose the right route, take a short diagnostic.",
        ...
        "progress.week": "📅 Step {week} of {max_weeks} · {pct}% complete",
        ...
        "week.acked": "✅ *Step {week} completed!*\n\nNext step is now open. In sha Allah 🌿",
        "lesson.ready": "New step is open! Open the Mini App to study the material.",
        ...
        "reminders.soon": "🔔 Reminders will be here soon. The main step now is to take the diagnostic and choose your route.",
    ...
    "ar": {
        ...
        "bottom.howto": "❓ كيفية المتابعة",
        "bottom.program": "📚 البرنامج",
        "bottom.payment": "💳 الدفع",
        "bottom.reminders": "🔔 التذكيرات",
        "bottom.curator": "💬 تواصل مع المشرف",
        "bottom.muhasaba": "🌙 المحاسبة",
        "bottom.site": "🌐 الموقع",
        "bottom.jarwas": "🤖 جروس",
        "bottom.help": "🙋 تحتاج مساعدة",
        "bottom.channel": "📢 القناة",
        "bottom.language": "🌍 اللغة",
        "bottom.placeholder": "اختر إجراءً",
        ...
        "diag.level_a": "I — الصحوة (أخطو الخطوات الأولى)",
        "diag.level_b": "II — الممارسة (أدخلها في حياتي)",
        "diag.level_c": "III — البركة (أعيش بها كجزء مني)",
        ...
        "diag.button": "🎯 ابدأ التشخيص",
        "diag.prompt": "🎯 اضغط الزر أدناه لبدء التشخيص:",
        "diag.route_prompt": "🎯 لاختيار المسار المناسب، ابدأ تشخيصاً قصيراً.",
        ...
        "progress.week": "📅 الخطوة {week} من {max_weeks} · اكتمل {pct}%",
        "week.not_active": "لم يتم تفعيلك في البرنامج.",
        "week.graduated": "🎓 *مبارك!*\n\nلقد أتممت *{level}*!\n\nبارك الله فيك. تواصل مع المشرف للانتقال إلى المستوى التالي. 🌿",
        "week.acked": "✅ *اكتملت الخطوة {week}!*\n\nالخطوة التالية مفتوحة الآن. إن شاء الله 🌿",
        "lesson.ready": "خطوة جديدة مفتوحة! افتح التطبيق المصغر لدراسة المادة.",
        ...
        "reminders.soon": "🔔 ستكون التذكيرات هنا قريباً. الخطوة الأساسية الآن هي التشخيص واختيار المسار.",
    ...
    "de": {
        ...
        "progress.week": "📅 Schritt {week} von {max_weeks} · {pct}% abgeschlossen",
        ...
        "week.acked": "✅ *Schritt {week} abgeschlossen!*\n\nDer nächste Schritt ist jetzt offen. In sha Allah 🌿",
        "lesson.ready": "Neuer Schritt ist offen! Öffne die Mini App, um das Material zu lernen.",
...
EXTRA_LANGUAGE_TEXTS = {
    "tr": {
        ...
        "menu.jarwas": "🤖 Jarwas — AI mentor",
        "menu.howto": "Programa nasıl devam edilir",
        "menu.language": "🌍 Dil",
        "menu.updated": "Menü güncellendi · {version}",
        "bottom.diag": "🎯 Teşhis",
        "bottom.miniapp": "📱 Kişisel kabinet",
        "bottom.howto": "❓ Nasıl devam edilir",
        "bottom.program": "📚 Program",
        "bottom.payment": "💳 Ödeme",
        "bottom.reminders": "🔔 Hatırlatmalar",
        "bottom.curator": "💬 Küratörle iletişim",
        "bottom.muhasaba": "🌙 Muhasebe",
        "bottom.site": "🌐 Site",
        "bottom.jarwas": "🤖 Jarwas",
        "bottom.help": "🙋 Yardım",
        "bottom.channel": "📢 Kanal",
        "bottom.language": "🌍 Dil",
        "bottom.placeholder": "Eylem seç",
        ...
        "diag.level_a": "I — Uyanış (ilk adımları atıyorum)",
        "diag.level_b": "II — Pratik (hayatıma yerleştiriyorum)",
        "diag.level_c": "III — Bereket (bu benim parçam; bereketle yaşıyorum)",
        "diag.button": "🎯 Teşhise başla",
        "diag.prompt": "🎯 Teşhise başlamak için aşağıdaki düğmeye bas:",
        "diag.route_prompt": "🎯 Doğru rotayı seçmek için kısa teşhisten geç.",
        ...
        "reminders.soon": "🔔 Hatırlatmalar yakında burada olacak. Şimdi ana adım teşhisten geçip rotanı seçmek.",
...
DIAG_QUESTIONS = {
    "ru": [
        ...
        ("7️⃣ Как твой бизнес или работа?", [("🌀 Полный хаос", 0), ("⚙️ Без системы", 1), ("📊 Система есть — нет баракат", 2), ("✨ Ищу смысл", 3)]),
