...
TEXTS = {
    "ru": {
        ...
        "payments.success": "✅ *Оплата получена! БаракАллах фикум* 🤍\n\n*{tariff}* — {amount} ₽\n\n🌱 Доступ открыт — программа активирована прямо сейчас!\nНажми /start чтобы начать. ин ша Аллах 🌿",
    ...
    "en": {
        ...
        "payments.success": "✅ *Payment received! BarakAllahu feekum* 🤍\n\n*{tariff}* — {amount} ₽\n\n🌱 Access granted — your program is active right now!\nPress /start to begin, in sha Allah 🌿",
    ...
    "ar": {
        ...
        "payments.success": "✅ *تم استلام الدفع! بارك الله فيكم* 🤍\n\n*{tariff}* — {amount} ₽\n\n🌱 تم فتح الوصول — البرنامج مفعّل الآن!\nاضغط /start للبدء، إن شاء الله 🌿",
    ...
    "de": {
        ...
        "payments.success": "✅ *Zahlung erhalten! BarakAllahu feekum* 🤍\n\n*{tariff}* — {amount} ₽\n\n🌱 Zugang gewährt — dein Programm ist jetzt aktiv!\nDrücke /start, um zu beginnen, in sha Allah 🌿",
