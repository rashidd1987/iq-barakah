...
TARIFFS = [
    ...
    },
    {
        ...
        "desc": "Сезон 1 · Основание · 8 недель · помесячно",
        "price": 5_000,
    },
    {
        "id": "s1_full",
    ...
    },
    {
        "id": "jamaat",
        "name": "👥 Поток",
        "desc": "Групповой поток · по запросу",
        "price": 0,
    },
    {
        "id": "leader",
...
TARIFF_TEXTS = {
    "ru": {
        "vakt": ("🌱 IQ Barakah Старт", "Тайм-менеджмент мусульманина · 6 недель"),
        "s1_month": ("📗 Путь IQ Barakah", "Сезон 1 · Основание · 8 недель · помесячно"),
        ...
        "jamaat": ("👥 Поток", "Групповой поток · по запросу"),
...
def get_result(score: int, is_female: bool) -> dict:
    ...
    if pct <= 25:
        return dict(level_key="А", pct=pct, emoji="🔴",
            ...
            path="🌱 IQ Barakah Старт — Тайм-менеджмент мусульманина")
    elif pct <= 50:
        return dict(level_key="Б", pct=pct, emoji="🔵",
            ...
            path="🌱 IQ Barakah Старт → 📗 Сезон 1 · Основание")
    elif pct <= 75:
