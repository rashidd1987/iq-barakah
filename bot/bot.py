...
🌱 ВАКТ · Тайм-менеджмент мусульманина (6 недель):
  Неделя 1: Ният — топливо жизни
  Неделя 2: Фаджр — якорь дня
  Неделя 3: Священное пространство
  Неделя 4: Время как свидетель
  Неделя 5: Мухасаба — вечерний отчёт
  Неделя 6: Истикама — договор с собой

📗 Сезон 1 · Основание — Кто ты есть (8 недель):
  C1.1: Тайный разговор · C1.2: Возвращение домой · C1.3: Священное пространство
  C1.4: Время как свидетель · C1.5: Кто твой Господь? · C1.6: Нулевой километр
  C1.7: Ты — не мозг в банке · C1.8: Генеральная уборка души

📘 Сезон 2 · Строительство — Как ты живёшь (8 недель):
  C2.1: Как шайтан взламывает мозг · C2.2: Строительство крепости · C2.3: Сжигание кораблей
  C2.4: Что тяжелее всего на весах? · C2.5: Дай плату пока не высох пот · C2.6: Самый длинный аят
  C2.7: Партнёрство с Аллахом · C2.8: Синдром Атланта

📙 Сезон 3 · Наследие — Зачем ты живёшь (8 недель):
  C3.1: У подножия их ног · C3.2: Оставь войну за порогом · C3.3: Зеркальные нейроны
  C3.4: Кузнец и парфюмер · C3.5: Король без короны · C3.6: Река и болото
  C3.7: Открытый счёт · C3.8: Точка невозврата
...
async def cmd_program(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "B1 🌿 Ният — топливо жизни\n"
        "B2 🏁 Фаджр — якорь дня\n"
        "B3 🏠 Священное пространство\n"
        "B4 ⏱ Время как свидетель\n"
        "B5 🌙 Мухасаба — вечерний отчёт\n"
        "B6 🏆 Истикама — договор с собой\n\n"
        "━━━━━━━━━━━━━━━━\n"
        "📗 *Сезон 1 · Основание · Кто ты есть* — 8 недель\n\n"
