...
PROGRAM = {
    ...
    "В": [
        {
            "title": "С2.1 · Нафс — изучение себя",
            "text": (
                "🧠 *Кто управляет тобой изнутри?*\n\n"
                "Нафс — это твоя внутренняя природа. Её нельзя победить — "
                "только понять и направить. Эта неделя — честное исследование."
            ),
            "tasks": [
                "📓 Веди дневник нафса — записывай каждый импульс за которым пошёл",
                "🔍 Найди свой главный триггер: что чаще всего выбивает из колеи?",
                "🤲 Дуа от нафса: «Аллахумма инни а'узу бика мин шарри нафси»",
            ],
        },
        {
            "title": "С2.2 · Нафс — работа с собой",
            "text": (
                "⚙️ *Знать — мало. Нужно работать.*\n\n"
                "«Кто победил свой нафс — тот истинный сильный» (хадис). "
                "Эта неделя — конкретные инструменты управления нафсом."
            ),
            "tasks": [
                "⏸️ Правило 5 минут: перед любым импульсивным действием — пауза",
                "📿 Истигфар 100 раз в день — очищает нафс",
                "📊 В конце недели: где нафс победил тебя? Где ты — его?",
            ],
        },
        {
            "title": "С2.3 · Ахляк — нравственность",
            "text": (
                "✨ *Пророк ﷺ был послан для завершения благородных нравов.*\n\n"
                "Ахляк — это не набор правил, это характер. "
                "Эта неделя — выбрать одно качество и укреплять его каждый день."
            ),
            "tasks": [
                "🌿 Выбери одно качество: терпение, щедрость, честность — практикуй 7 дней",
                "😊 Улыбнись каждому мусульманину которого встретишь — это садака",
                "📓 Вечером: был ли я лучшей версией себя сегодня?",
            ],
        },
        {
            "title": "С2.4 · Уммет — связь с общиной",
            "text": (
                "🤝 *Мусульманин не одиночка. Умма — это семья.*\n\n"
                "«Верующие в своей любви и милости подобны одному телу» (хадис). "
                "Эта неделя — укрепить связи с уммой."
            ),
            "tasks": [
                "🕌 Посети мечеть хотя бы на одном джамаате кроме пятницы",
                "🤲 Сделай дуа за 5 мусульман по именам",
                "💬 Напиши якорному брату: «Как твоя неделя?»",
            ],
        },
        {
            "title": "С2.5 · Лидерство — служение",
            "text": (
                "👑 *Настоящий лидер — тот кто служит.*\n\n"
                "«Господин народа — их слуга» (хадис). "
                "Эта неделя — найти как ты можешь служить тем кто рядом."
            ),
            "tasks": [
                "🙋 Сделай что-то хорошее для кого-то — не рассказывая об этом",
                "📋 Напиши список людей за которых ты несёшь ответственность",
                "🎯 Поставь одну цель которая принесёт пользу другим людям",
            ],
        },
        {
            "title": "С2.6 · Даават — призыв",
            "text": (
                "📢 *Передай то что знаешь.*\n\n"
                "«Донеси от меня хотя бы один аят» (хадис). "
                "Даават начинается с примера — не с проповеди."
            ),
            "tasks": [
                "💡 Поделись одним знанием из программы с кем-то близким",
                "📱 Напиши пост или голосовое — что изменилось в тебе за этот сезон",
                "🤲 Дуа: «Аллахумма اهدني и هَدِّ بي» — попроси Аллаха направить тебя и через тебя",
            ],
        },
        {
            "title": "С2.7 · Такуа — богобоязненность",
            "text": (
                "🌙 *Такуа — это не страх. Это любовь со вниманием.*\n\n"
                "«Поистине, самый почитаемый из вас перед Аллахом — "
                "самый богобоязненный» (Аль-Худжурат, 13). "
                "Эта неделя — жить с ощущением присутствия Аллаха."
            ),
            "tasks": [
                "🌅 Каждое утро: «Аллах видит меня» — и держи это весь день",
                "🚫 Откажись от одного харам-действия которое знаешь",
                "📖 Прочитай суру Аль-Хашр (последние 3 аята) — тафсир такуа",
            ],
        },
        {
            "title": "С2.8 · Итог С2 · Готов к Наследию",
            "text": (
                "🌟 *МашаАллах, {name}! Сезон 2 · Строительство завершён.*\n\n"
                "✅ Нафс — изучен и управляем\n"
                "✅ Ахляк — практикуется\n"
                "✅ Умма — связан\n"
                "✅ Лидерство — служение\n"
                "✅ Такуа — живёт\n\n"
                "Впереди — Сезон 3 · Наследие: ЗАЧЕМ ты живёшь."
            ),
            "tasks": [
                "📝 Письмо себе: чем ты отличаешься от себя 16 недель назад?",
                "🌍 Запусти одно дело садака джария — что останется после тебя",
                "🚀 Сезон 3 · Наследие — твоя миссия ждёт",
            ],
        },
    ],
}
...
async def cmd_program(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "_ЗАЧЕМ ты живёшь_\n"
        "Трансформация · Миссия · Влияние · Садака джария\n\n"
        "━━━━━━━━━━━━━━━━\n"
