    ...
    "А": [
        {
            ...
            "text": (
                "Ты когда-нибудь замечал: два человека делают одно и то же — "
                "один получает баракат (благодать), второй только усталость. "
                "Разница не в действии. Разница в том, что у него внутри.\n\n"
                "Пророк ﷺ сказал: _«Поистине, дела оцениваются только по намерениям»_ (Бухари).\n\n"
                "Ният (намерение) — философский камень. Он превращает обычную рутину в золото "
                "поклонения. Работа ради Аллаха — это ибадат (поклонение). Еда с «Бисмиллях» — "
                "это ибадат. Даже сон с правильным намерением — это ибадат.\n\n"
                "Проблема в том, что мы живём на автопилоте. Встали — взяли телефон. "
                "Поели — полистали ленту. Мы роботы. Мы забыли, зачем делаем то, что делаем.\n\n"
                "Когда намерение стирается — любое дело становится тяжёлым. "
                "Но если делаешь ради Аллаха — тебе не нужно чьё-то «спасибо». "
                "Ты уже получил награду в момент действия.\n\n"
                "*Инструмент недели — «3 секунды»:* перед каждым переключением дел замри. "
                "Спроси: «Ради кого я это делаю?» Если ответ не «ради Аллаха» — обнови настройки.\n\n"
                "_Сейчас ты прикоснулся к этой теме. В IQ Barakah мы разберём её на глубину — "
                "инструменты, практики, психология._"
            ),
            "tasks": {
                "А": [
                    "📿 Скажи «Бисмиллях» (с именем Аллаха) перед едой — осознанно, не на автомате",
                    "🕐 Один раз за день сделай паузу перед любым делом и скажи про себя: «Ради Аллаха»",
                ...
                "В": [
                    ...
                    "✨ Весь день — ният аль-ихляс (намерение искренности): осознанное намерение во всех делах",
        ...
        },
        {
            ...
            "text": (
                "Есть один момент который определяет весь твой день. "
                "Не планёрка в 9 утра. Не первая чашка кофе. Фаджр (утренняя молитва, на рассвете).\n\n"
                "Пророк ﷺ сказал: _«Кто совершит Фаджр-намаз — находится под защитой Аллаха»_ (Муслим). "
                "Тот, кто встаёт с Фаджром — контролирует утро. Тот, кто контролирует утро — контролирует день.\n\n"
                "Человек который начинает день с телефона — начинает день с чужих повесток: "
                "чужие новости, чужие проблемы. Его день начинается в режиме реакции. "
                "Человек который начинает день с Фаджра — задаёт тон сам.\n\n"
                "Мы не говорим о совершенстве. Мы говорим о первом шаге. "
                "Встать чуть раньше. Побыть в тишине. Почувствовать что утро — подарок.\n\n"
                "*Инструмент недели — «Утренний якорь»:* одно действие сразу после подъёма, до телефона. "
                "Дуа (молитва-просьба) пробуждения. Стакан воды. «АльхамдулиЛлях» (хвала Аллаху). "
                "Один якорь — и утро уже другое."
            ),
            "tasks": {
                "А": [
        ...
        },
        {
            ...
            "text": (
                "Есть груз тяжелее любого физического. Незакрытые счета с прошлым. "
                "Грехи о которых помнишь. Слова которые сказал. Дела которые не сделал. "
                "Этот груз тормозит сильнее, чем любая усталость.\n\n"
                "Аллах сказал: _«О рабы Мои, которые преступили против себя — не отчаивайтесь "
                "в милости Аллаха. Поистине, Аллах прощает грехи полностью»_ (Зумар, 53).\n\n"
                "Тауба (покаяние, возвращение к Аллаху) — не слабость. Тауба — инструмент. "
                "Пророк ﷺ делал истигфар (просьбу о прощении) более 70 раз в день. "
                "Не потому что был грешником. Потому что понимал: "
                "очищение сердца — это техническое обслуживание которое нужно регулярно.\n\n"
                "Ты не можешь строить будущее, таща за собой прошлое. "
                "Тауба освобождает место. Очищает холст. Позволяет начать прямо сейчас.\n\n"
                "*Инструмент недели — «Ежедневная тауба»:* каждое утро после Фаджра — "
                "3 минуты истигфара. Не как ритуал, а как разговор: "
                "«О Аллах, вот что было вчера. Прости. Сегодня попробую иначе»."
            ),
            "tasks": {
                "А": [
                    "📿 Скажи «АстагфируЛлах» (прошу прощения у Аллаха) 10 раз перед сном — просто попробуй",
                ...
                "В": [
                    ...
                    "🤝 Помоги кому-то рядом понять: Аллах прощает. Передай этот аят",
                ],
            },
        },
        {
            ...
            "text": (
                "_«Поистине, Аллах с терпеливыми»_ (Бакара, 153).\n\n"
                "Аллах не сказал «с теми, кто не ошибается». Он сказал — с терпеливыми. "
                "С теми, кто идёт дальше несмотря на трудность.\n\n"
                "Все начинают с огня. Рамадан — намаз пять раз. Январь — зарядка каждый день. "
                "А потом приходит настоящая жизнь. Усталость. Проблема на работе. Ссора дома. "
                "И человек либо тонет в самобичевании, либо тихо встаёт и продолжает.\n\n"
                "Сабр (терпение, устойчивость) — не «стиснуть зубы и терпеть». "
                "Это способность держать курс когда штормит. Двигаться без паники, без срыва.\n\n"
                "Пророк ﷺ сказал: _«Удивительно дело верующего — всё в нём благо. "
                "Если его постигает хорошее — он делает шукр (благодарит). "
                "Если плохое — делает сабр (терпит)»_ (Муслим).\n\n"
                "*Инструмент недели — «Правило следующего шага»:* когда сорвался — "
                "не ругай себя часами. Один вопрос: «Какой один шаг я могу сделать прямо сейчас?» "
                "Пропустил намаз — соверши следующий. Не назад. Следующий шаг."
            ),
            "tasks": {
                "А": [
                ...
                "Б": [
                    "📓 Веди «дневник сабра»: где сегодня держался, где нет — без осуждения, как наблюдатель",
                    "⏱ Выбери одну трудную задачу и делай её по 15 минут каждый день — 7 дней",
                    "🤲 Выучи дуа при трудностях: «Иннаа лиллаахи ва иннаа иляйхи раажиун» (мы принадлежим Аллаху и к Нему возвращаемся)",
                ],
                "В": [
                    "📚 Изучи три вида сабра: при поклонении, при испытаниях, при воздержании от греха",
        ...
        },
        {
            ...
            "text": (
                "_«Поминайте Меня — и Я буду помнить вас»_ (Бакара, 152).\n\n"
                "Большинство помнят об Аллахе на намазе. После намаза — делают тасбих "
                "(прославление: «СубханАллах»). А потом жизнь забирает обратно. "
                "Работа, телефон, дела. И Аллах как будто остаётся «там — в мечети».\n\n"
                "Но Он Аль-Кариб (Ближний). "
                "_«Мы ближе к нему, чем его яремная вена»_ (Каф, 16). "
                "Он здесь. Всегда. Вопрос только — помним ли мы.\n\n"
                "Зикр (поминание Аллаха) — это не только чётки после намаза. Это состояние. "
                "«СубханАллах» (Пречист Аллах) видя красивый закат. "
                "«АльхамдулиЛлях» (хвала Аллаху) когда всё хорошо. "
                "«МашаАллах» (что пожелал Аллах) когда достигаешь цели.\n\n"
                "Человек который помнит Аллаха — живёт в другом измерении. "
                "Его не разрушают новости. Его не ломают трудности. "
                "Потому что сердце занято Тем, Кто не уходит.\n\n"
                "*Инструмент недели — «Зикр-якоря»:* привяжи конкретный азкар (поминание) "
                "к конкретному действию. Выход из дома — «Бисмиллях, таввакальту аляЛлах» "
                "(на Аллаха уповаю). Открываешь ноутбук — «АстагфируЛлах». "
                "Три якоря — и зикр встроен в жизнь."
            ),
            "tasks": {
                "А": [
                    "📿 Выбери один зикр-якорь: например «АльхамдулиЛлях» каждый раз когда пьёшь воду",
        ...
        },
        {
            ...
            "text": (
                "_«Самое любимое дело перед Аллахом — то, которое постоянно, даже если оно мало»_ "
                "(Бухари).\n\n"
                "Шесть недель. Ният (намерение). Фаджр (утро). Тауба (покаяние). "
                "Сабр (терпение). Зикр (поминание). Это не просто темы — это фундамент.\n\n"
                "Теперь главный вопрос: что из этого стало твоим? Что работает? "
                "Что пока даётся трудно? Где держался, а где ещё нет?\n\n"
                "ВАКТ — был трамплин. Не финиш. Система — это не когда тебе легко. "
                "Это твоё поведение в самый трудный момент.\n\n"
                "В IQ Barakah каждый найдёт своё место — на своём уровне, в своём темпе. "
                "Там эти же темы разберём на глубину: психология, исламские науки, "
                "практические инструменты для жизни, бизнеса и семьи."
            ),
            "tasks": {
                "А": [
