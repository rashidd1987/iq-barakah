...
🌱 ВАКТ · Тайм-менеджмент мусульманина (6 недель):
  Неделя 1: Ният (намерение) — тайный разговор
  Неделя 2: Фаджр (утренняя молитва) — якорь дня
  Неделя 3: Тауба (покаяние) — чистый лист
  Неделя 4: Сабр (терпение) — держи курс
  Неделя 5: Зикр (поминание Аллаха) — Аллах в каждом деле
  Неделя 6: Итог — твоя система

📗 Сезон 1 · Основание — Кто ты есть (8 недель):
  C1.1: Тайный разговор · C1.2: Возвращение домой · C1.3: Среда побеждает волю
  C1.4: Ихсан — одно дело полностью · C1.5: Кто твой Господь? · C1.6: Нулевой километр
...
PROGRAM = {
    ...
    "Б": [
        ...
        {
            "title": "С1.3 · Среда побеждает волю",
            "text": (
        ...
        {
            "title": "С1.4 · Ихсан — одно дело полностью",
            "text": (
...
async def cmd_program(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "C1.3 🏠 Среда побеждает волю\n"
        "C1.4 ⏱ Ихсан — одно дело полностью\n"
