...
TARIFFS = [
    ...
    },
    {
        ...
        "details": (
            ...
            "👤 Личный наставник\n"
            "📱 Telegram-бот + Mini App\n"
            "📞 Еженедельные созвоны с Рашидом\n\n"
            "💰 *10 000 ₽*\n"
    ...
    },
    {
        "id": "leader",
        "name": "👑 Лидер Уммы",
        "desc": "Индивидуально с Рашидом",
        "price": 250000,
        "details": (
            "👑 *Лидер Уммы*\n\n"
            "📅 Ежемесячная оплата\n"
            "🤝 Работа 1 на 1 с Рашидом\n"
    ...
    for uid_str in active:
        try:
            await ctx.bot.send_message(
                ...
                parse_mode="Markdown",
                text=(
                    "📞 *Через 15 минут — живой созвон с Рашидом!*\n\n"
                    "🕑 Сегодня в *14:00 МСК*\n\n"
